...
<body>
    <div class="flex justify-center mt-10 mx-2">
        <div class="border border-black p-5 rounded-xl gap-3 flex flex-col w-[600px] bg-white shadow-xl">
            ...
            @endif
            <h1 class="text-2xl font-bold text-center">Edit Post</h1>
            <p class="text-center">Input the field bellow to edit a post</p>
            <form action="{{ route('post.update', $post->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="flex flex-row gap-2 items-center">
                    ...
                    <input type="file" name="image"
                        class="border border-black rounded-md p-1 w-full cursor-pointer"
                ...
                @enderror"
                        autocomplete="off" value="{{ old('link', $post->link) }}">
                </div>
                {{-- Category_id --}}
                <div class="flex flex-row gap-2 items-center">
                ...
                @enderror"
                        autocomplete="off" value="{{ old('category_id', $post->category_id) }}">
                </div>
                {{-- Description --}}
                <div class="flex flex-row gap-2 items-center">
