<footer class="bg-slate-800 text-white shadow-sm">
    <div class="w-full max-w-7xl mx-auto p-4 md:py-8">
        <div class="flex flex-col md:flex-row gap-5 items-center justify-between">
            ...
            {{-- Tengah --}}
            <ul class="flex flex-col md:flex-row items-center font-medium text-white gap-2">
                <li>
            ...
            <div class="flex gap-2">
                <a href="https://www.facebook.com/Taupikzaki" target="_blank" class="social hover:bg-[#1877F2]">
                ...
                <a href="https://www.youtube.com/@TaupikZaki" target="_blank" class="social hover:hover:bg-red-600">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5">
                        <path
                ...
                <a href="https://github.com/" target="_blank" class="social hover:hover:bg-[#6e5494]">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5">
                        <path
        ...
        <div class="flex flex-col md:flex-row md:gap-2 justify-center text-sm md:text-[16px]">
            <div class="flex flex-row gap-2 text-center justify-center items-center">
                <p>
                    ©
                    <span id="year"></span>
                </p>
            ...
            <p class="hidden md:flex items-center">-</p>
            <div class="flex flex-row gap-2 text-center justify-center items-center">
